...
<form action="/service?action=house" method="post">
    <div class="container-fluid">
        <div class="row">
            <div class=" col-lg-12"></div>
            <table class="table" style="background: #8fd19e ;">
                <tr style="background: #218838">
                    <th colspan="2"><h3 style="text-align: center">Add House</h3></th>
                </tr>
                <tr>
                    <th>Name</th>
                    <td>
                ...
                <tr>
                    <th>Service type</th>
                    <td>
                        <input disabled type="text" name="serviceType" id="serviceType" value="House">
                    </td>
                </tr>
                <tr>
                    <th>Standard room</th>
