    ...
    <div class="col-lg-9">
        <div style="background: #34ce57 ;width: 150px;height: 40px;border-radius:50px ">
            <a style="text-decoration: none" href="#">
                <p style="width: 100%;height: 100%;line-height: 40px;text-align: center">Add Contract</p></a>
        </div>
    </div>
    <div class="col-lg-3">
        <form class="d-flex ">
            ...
            <div style="width: 100%">
                <table class="table" style="background: #8fd19e;">
                    ...
                    <tr style="background: #218838">
                        ...
                        <th colspan="10" scope="row"><h3 style="text-align: center">List contract</h3></th>
