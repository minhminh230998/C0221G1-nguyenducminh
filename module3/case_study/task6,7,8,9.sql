...
dich_vu.chi_phi_thue,loai_dich_vu.loai_dich_vu,hop_dong.id_hop_dong,hop_dong.ngay_bat_dau
from loai_dich_vu
join dich_vu
...
dich_vu.id_dich_vu not in(
 ...
 and month(hop_dong.ngay_bat_dau) in (1,2,3)));
...
select dich_vu.id_dich_vu,dich_vu.ten_dich_vu,dich_vu.dien_tich_su_dung,
dich_vu.so_nguoi_toi_da,dich_vu.chi_phi_thue,loai_dich_vu.loai_dich_vu,hop_dong.ngay_bat_dau
from loai_dich_vu
join dich_vu
...
in 
	(select hop_dong.ngay_bat_dau from hop_dong where year(hop_dong.ngay_bat_dau) = 2018)
and hop_dong.id_dich_vu
not in
	(select hop_dong.id_dich_vu from hop_dong where year(hop_dong.ngay_bat_dau) = 2019);
