...
public class ThemPhuongTien implements Regex {
    ...
    public static void themXeOto() {
        ...
        System.out.println("Nhập biển kiểm soát");
        String bienKiemSoat = sc.nextLine();
        while (!Pattern.matches(SO_XE_OTO, bienKiemSoat)) {
            System.out.println("Vui lòng nhập đúng");
            bienKiemSoat = sc.nextLine();
        }
        ...
        listOto.add(Oto1);
        try {
            FileWriter fw = new FileWriter(XE_OTO_CSV,true);
            BufferedWriter bw = new BufferedWriter(fw);
            for (Oto s:listOto){
    ...
    public static void themXeMay() {
        ...
        System.out.println("Nhập biển kiểm soát");
        String bienKiemSoat = sc.nextLine();
        while (!Pattern.matches(SO_XE_MAY, bienKiemSoat)) {
            System.out.println("Vui lòng nhập đúng");
            bienKiemSoat = sc.nextLine();
        }
        ...
        listXeMay.add(xeMay);
        try {
            FileWriter fw = new FileWriter(XE_MAY_CSV,true);
            BufferedWriter bw = new BufferedWriter(fw);
